...
public interface IOplusRadioIndication extends IBase {
    ...
    static IOplusRadioIndication asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        final IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof IOplusRadioIndication)) {
            return (IOplusRadioIndication) iface;
        }
        final IOplusRadioIndication proxy = new Proxy(binder);
        try {
    ...
    static IOplusRadioIndication castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IOplusRadioIndication getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IOplusRadioIndication getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IOplusRadioIndication getService(String serviceName) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName));
    }

    static IOplusRadioIndication getService() throws RemoteException {
        return getService("default");
    }

    public static final class Proxy implements IOplusRadioIndication {
    ...
    public static abstract class Stub extends HwBinder implements IOplusRadioIndication {
        ...
        public final ArrayList<byte[]> getHashChain() {
            return new ArrayList<>(Arrays.asList(
                    new byte[]{-126, 115, 97, 84, -67, 82, 42, 56, 1, -55, 91, -75, 117, 7, 3, 78, 26, -29, -67, -34, 10, 11, 72, 26, 48, 108, 64, 91, -124, -93, -90, 8},
