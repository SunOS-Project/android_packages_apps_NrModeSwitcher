...
public interface IOplusRadioResponse extends IBase {
    ...
    static IOplusRadioResponse asInterface(IHwBinder binder) {
        if (binder == null) {
            return null;
        }
        final IHwInterface iface = binder.queryLocalInterface(kInterfaceName);
        if (iface != null && (iface instanceof IOplusRadioResponse)) {
            return (IOplusRadioResponse) iface;
        }
        final IOplusRadioResponse proxy = new Proxy(binder);
        try {
    ...
    static IOplusRadioResponse castFrom(IHwInterface iface) {
        if (iface == null) {
            return null;
        }
    ...
    static IOplusRadioResponse getService(String serviceName, boolean retry) throws RemoteException {
        return asInterface(HwBinder.getService(kInterfaceName, serviceName, retry));
    }

    static IOplusRadioResponse getService(boolean retry) throws RemoteException {
        return getService("default", retry);
    }

    static IOplusRadioResponse getService(String serviceName) throws RemoteException {
